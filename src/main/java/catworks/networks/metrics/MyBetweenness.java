package catworks.networks.metrics; // NOTE: This is valid, even if VSCode reports a "problem".
...
/**
 * Modified implementation of betweenness based on this implementation:
...
public class MyBetweenness implements Centrality {
    ...
    public Double[] getCentralities(Integer[][] graph) {
        ...
        for (Integer s : V) {
            ...
            for (Integer w : V) path.put(w, new ArrayList<Integer>());
            ...
            for (Integer t : V) sigma.put(t, 0.0);
            sigma.put(s, 1.0);
     ...
     */
    private ArrayList<Integer> neighbors(Integer node, Integer[][] graph) {
